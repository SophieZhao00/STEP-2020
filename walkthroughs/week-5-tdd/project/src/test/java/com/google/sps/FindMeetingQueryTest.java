...
public final class FindMeetingQueryTest {
  ...
  public void optionalAttendeeWithAllDayEvent() {
    // Based on everyAttendeeIsConsidered,
    // Add an optional attendee C who has all day event
    //
    // Events  :       |--A--|     |--B--|
    // Optional: |--------------C--------------|
    // Day     : |-----------------------------|
  ...
  public void optionalAttendee() {
    // Based on everyAttendeeIsConsidered,
    // Add an optional attendee C who has an event.
    // Eliminate one time slot.
    //
    // Events  :       |--A--|     |--B--|
    // Optional:             |--C--|
    // Day     : |-----------------------------|
  ...
  public void justEnoughRoomWithOptionalAttendee() {
    ...
    // Add attendee B who would result a time slot samller than requested time.
    // As a result, attendee B should not be included.
    //
    // Events  : |--A--|     |----A----|
    // Optional:       |-B-|
    // Day     : |---------------------|
